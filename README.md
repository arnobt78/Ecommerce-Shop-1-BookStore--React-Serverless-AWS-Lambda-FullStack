# CodeBook E-Commerce Platform - React, AWS (Lambda, DynamoDB, S3, HTTP API Gateway) Serverless Architecture FullStack Project (including Admin Panel with Analytics, User Management, Order Processing, Review Moderation, Activity Logging)
